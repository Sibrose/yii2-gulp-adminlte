...
class CKFinder
{
	...
	// PHP 5 Constructor
	function __construct( $basePath = CKFINDER_DEFAULT_BASEPATH, $width = '100%', $height = '100%', $selectFunction = null )
	{
	...
	public function CreateHtml()
	{
		...
		return '<iframe src="' . $this->_BuildUrl() . '" width="' . $this->Width . '" ' .
			'height="100%' . $className . $id . ' frameborder="0" scrolling="no"></iframe>' ;
	}
	...
	// Static "Create".
	public static function CreateStatic( $basePath = CKFINDER_DEFAULT_BASEPATH, $width = '100%', $height = '100%', $selectFunction = null )
	{
	...
	public function SetupFCKeditorObject( &$editorObj, $imageType = null, $flashType = null )
	{
		...
		if ( $this->Height !== '100%' && is_numeric( str_ireplace( "px", "", $this->Height ) ) )
		{
