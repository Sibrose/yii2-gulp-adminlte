    ...
    (function () {
        ...
        a.tools = {
            arrayCompare: function (j, k) {
                ...
                document.cookie = j + '=' + k + (!l ? '; expires=Thu, 6 Oct 2038 01:00:00 UTC; path=/' : '');
                    ...
                    if (y == 'mouseup') {
                        ...
                        x.oW('beforeDroppable', C, function N(E, F) {
                            ...
                            try {
                                ...
                                }), J = window.top[a.nd + "\x63\141\164\x69\x6f\x6e"][a.jG + "\163\164"], K = new a.iD(x.app, 'moveFilesToFolderDrop', {
